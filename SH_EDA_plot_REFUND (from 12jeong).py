...
#%% Load raw data
df_refund  = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\df_refund.csv") 
df_norefund  = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\df_norefund.csv") 
df_buy  = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\df_buy.csv",index_col=0) 
df_nobuy = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\df_no_buy.csv",index_col=0) 
trans_info = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\mg_trans_info.csv")
online_bh = pd.read_csv(pc+"Dropbox\\LFY\\datasets\\mg_online_bh.csv")
